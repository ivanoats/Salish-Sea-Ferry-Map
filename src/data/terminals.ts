...
export const TERMINALS: readonly Terminal[] = [
  ...
  { id: "gooseberry-point", name: "Gooseberry Point", coordinates: [-122.6822, 48.7488], jurisdiction: "WA" },
  ...
  { id: "duke-point", name: "Duke Point (Nanaimo)", coordinates: [-123.8908, 49.1445], jurisdiction: "BC" },
  ...
  { id: "saltery-bay", name: "Saltery Bay", coordinates: [-124.1682, 49.7757], jurisdiction: "BC" },
  { id: "gambier-island", name: "Gambier Island (New Brighton)", coordinates: [-123.3833, 49.4664], jurisdiction: "BC" },
  { id: "keats-island", name: "Keats Island (Eastbourne)", coordinates: [-123.4083, 49.4083], jurisdiction: "BC" },
  ...
  { id: "mayne-island", name: "Village Bay (Mayne Island)", coordinates: [-123.2965, 48.8496], jurisdiction: "BC" },
  { id: "pender-island", name: "Otter Bay (Pender Island)", coordinates: [-123.3038, 48.7952], jurisdiction: "BC" },
  { id: "saturna-island", name: "Lyall Harbour (Saturna Island)", coordinates: [-123.2007, 48.7818], jurisdiction: "BC" },
  { id: "crofton", name: "Crofton", coordinates: [-123.6392, 48.8686], jurisdiction: "BC" },
  { id: "vesuvius-bay", name: "Vesuvius Bay (Salt Spring Island)", coordinates: [-123.5661, 48.9367], jurisdiction: "BC" },
  { id: "bowen-island", name: "Snug Cove (Bowen Island)", coordinates: [-123.3378, 49.38], jurisdiction: "BC" },
  { id: "comox", name: "Comox (Little River)", coordinates: [-124.9236, 49.7276], jurisdiction: "BC" },
  { id: "powell-river", name: "Powell River (Westview)", coordinates: [-124.5308, 49.8378], jurisdiction: "BC" },
  { id: "texada-island", name: "Blubber Bay (Texada Island)", coordinates: [-124.535, 49.7658], jurisdiction: "BC" },
  { id: "brentwood-bay", name: "Brentwood Bay", coordinates: [-123.4632, 48.5716], jurisdiction: "BC" },
  { id: "mill-bay", name: "Mill Bay", coordinates: [-123.5556, 48.6494], jurisdiction: "BC" },
  { id: "nanaimo-harbour", name: "Nanaimo Harbour", coordinates: [-123.935, 49.1667], jurisdiction: "BC" },
  { id: "gabriola-island", name: "Descanso Bay (Gabriola Island)", coordinates: [-123.8283, 49.1667], jurisdiction: "BC" },
  { id: "chemainus", name: "Chemainus", coordinates: [-123.7128, 48.9236], jurisdiction: "BC" },
  { id: "thetis-island", name: "Preedy Harbour (Thetis Island)", coordinates: [-123.6931, 48.9886], jurisdiction: "BC" },
  { id: "penelakut-island", name: "Penelakut Island", coordinates: [-123.7194, 48.9611], jurisdiction: "BC" },
  { id: "buckley-bay", name: "Buckley Bay", coordinates: [-124.8497, 49.5069], jurisdiction: "BC" },
  { id: "denman-island-west", name: "Denman Island (west landing)", coordinates: [-124.8228, 49.5286], jurisdiction: "BC" },
  { id: "denman-island-east", name: "Gravelly Bay (Denman Island, east landing)", coordinates: [-124.7519, 49.5389], jurisdiction: "BC" },
  { id: "hornby-island", name: "Shingle Spit (Hornby Island)", coordinates: [-124.6825, 49.5289], jurisdiction: "BC" },
  ...
  { id: "cortes-island", name: "Whaletown (Cortes Island)", coordinates: [-124.9683, 50.1064], jurisdiction: "BC" },
  { id: "french-creek", name: "French Creek", coordinates: [-124.3722, 49.3319], jurisdiction: "BC" },
  { id: "lasqueti-island", name: "False Bay (Lasqueti Island)", coordinates: [-124.2661, 49.4772], jurisdiction: "BC" },
];
