...
export const TERMINALS: readonly Terminal[] = [
  ...
  { id: "penelakut-island", name: "Penelakut Island", coordinates: [-123.68036, 48.98592], jurisdiction: "BC" },
  { id: "buckley-bay", name: "Buckley Bay", coordinates: [-124.79979, 49.49813], jurisdiction: "BC" },
  ...
  { id: "hornby-island", name: "Shingle Spit (Hornby Island)", coordinates: [-124.71092, 49.51191], jurisdiction: "BC" },
